//<<<<<<< HEAD:src/test/java/com/usee/controller/getDanmuDetailsTest.java
...
@Transactional
public class GetDanmuDetailsTestCase {
...
//>>>>>>> upstream/dev:src/test/java/com/usee/controller/GetDanmuDetailsTestCase.java
}
